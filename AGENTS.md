...
- **Title:** Pebble Watch
- **Repository:** megageek/pebble-ha-integration

**Key directories:**

- `custom_components/pebble_ha_integration/` - Main integration code
...
- Integration logs: `custom_components.pebble_ha_integration: debug` in `config/configuration.yaml`
...
- **Domain:** `pebble_ha_integration`
- **Title:** Pebble Watch
- **Class prefix:** `PebbleWatch`

**When creating new files:**

- Use the domain `pebble_ha_integration` for all DOMAIN references
- Prefix all integration-specific classes with `PebbleWatch`
- Use "Pebble Watch" as the display title
...
- Inherit from platform base + `PebbleWatchEntity`
...
- `tests/` mirrors `custom_components/pebble_ha_integration/` structure
