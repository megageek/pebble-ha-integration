...
- **Main code:** `custom_components/pebble_ha_integration/`
...
- `entity/` — Base entity class (`PebbleWatchEntity`)
...
- Entity MRO: `(PlatformEntity, PebbleWatchEntity)` — order matters
...
- Debug level: `custom_components.pebble_ha_integration: debug` in `config/configuration.yaml`
