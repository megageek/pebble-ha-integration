# Getting Started with Pebble Watch

This guide will help you install and set up the Pebble Watch custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/megageek/pebble-ha-integration`
6. Set category to "Integration"
7. Click "Add"
8. Find "Pebble Watch" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/megageek/pebble-ha-integration/releases)
2. Extract the `pebble_ha_integration` folder from the archive
3. Copy it to `custom_components/pebble_ha_integration/` in your Home Assistant configuration directory
...
4. Select entities from "Pebble Watch"
...
- Report issues at [GitHub Issues](https://github.com/megageek/pebble-ha-integration/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/megageek/pebble-ha-integration/discussions)
