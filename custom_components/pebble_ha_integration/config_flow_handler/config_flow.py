...
from custom_components.pebble_ha_integration.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.pebble_ha_integration.config_flow_handler.validators import validate_credentials
from custom_components.pebble_ha_integration.const import DOMAIN, LOGGER
from homeassistant import config_entries
from homeassistant.const import CONF_PASSWORD, CONF_USERNAME
from homeassistant.loader import async_get_loaded_integration

if TYPE_CHECKING:
    from custom_components.pebble_ha_integration.config_flow_handler.options_flow import PebbleWatchOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "PebbleWatchApiClientAuthenticationError": "auth",
    "PebbleWatchApiClientCommunicationError": "connection",
}
...
class PebbleWatchConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.pebble_ha_integration.config_flow_handler.options_flow import (  # noqa: PLC0415
            PebbleWatchOptionsFlow,
        )

        return PebbleWatchOptionsFlow()
