"""Connectivity binary sensor for pebble_ha_integration."""
...
class PebbleWatchConnectivitySensor(BinarySensorEntity, PebbleWatchEntity):
    """Connectivity sensor for pebble_ha_integration."""
